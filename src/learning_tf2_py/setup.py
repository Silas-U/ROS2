...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'turtle_tf2_listener_debug = learning_tf2_py.turtle_tf2_listener_debug:main',
            'my_tf2_broadcaster = learning_tf2_py.my_tf2_broadcaster:main'
        ],
    },
)
